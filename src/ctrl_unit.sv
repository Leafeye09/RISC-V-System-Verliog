module ctrl_unit (
  ...
  output logic alu_src, reg_write, mem_read, mem_write, branch, jump
);
  always_comb begin
     	alu_ctrl  = 4'b0000;
        alu_src   = 0;
      ...
      7'b0110011: begin
            ...
            7'b1100011: begin
                ...
                case (funct3)
                    ...
                    3'b101: alu_ctrl = 4'b1000; // BGE  -> SLT, check not set
                    3'b110: alu_ctrl = 4'b1001; // BLTU -> SLTU
                    3'b111: alu_ctrl = 4'b1001; // BGEU -> SLTU, check not set
